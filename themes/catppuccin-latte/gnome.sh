...
gsettings set org.gnome.desktop.interface gtk-theme "Yaru-$OMARELL_THEME_COLOR"
...
gsettings set org.gnome.shell.extensions.user-theme name "Yaru-$OMARELL_THEME_COLOR"
